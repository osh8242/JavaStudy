...
>> 만약 초기값을 설정한다면 어떤 의미 : default 값을 바꾸겠다~~

local variable >> class Car { public void move(){int speed =0;} }>> 반드시 초기화 해야함
>> public static void main(String[] args){ 선언된 변수는 지역변수고 초기화 필}
